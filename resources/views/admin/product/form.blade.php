                            ...
                            <div class="col-md-6 bg-white" style="padding-top: 20px; padding-bottom: 20px;">
                                <form action="{{ route('admin.product.insert') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama" name="nama" placeholder="Enter new Product . . ." class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="harga" class="form-control-label">Rupiah's Price</label>
                                        <input type="text" id="harga" name="harga" placeholder="Enter Price" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="stok" class="form-control-label">STOK</label>
                                        <input type="number" min="1" id="stok" name="stok" placeholder="Number of STOK" class="form-control" required>
                                    </div>
                                    <div class="form-group">
